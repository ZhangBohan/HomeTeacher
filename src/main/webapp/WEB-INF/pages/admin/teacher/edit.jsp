...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		<jsp:include page="../../common/sidebar_admin.jsp" flush="true">
			<jsp:param name="activeMenu" value="teacher_show" />
		</jsp:include>
							...
							<div class="box">
								<div class="box-body">
									<div class="form-group">
										<img src="${teacherAccount.avatar}" class="avatar"> <input
											type="file" name="avatarFile" class="btn">
									</div>
									<!-- text input -->
									<div class="form-group">
										<label>名称</label> <span class="text-light-blue">在网站中显示的名称</span>
										<input type="text" name="name" class="form-control"
											placeholder="请输入名称" value="${teacherAccount.name}" />
									</div>
									<div class="form-group">
										<label>性别</label> <span class="text-light-blue">请填写性别，方便用户筛选</span>
										<c:choose>
											<c:when test="${teacherAccount.info.sex}">
											<input type="radio" name="sex" value="false">男 <input
											type="radio" name="sex" value="true" checked="true">女
											</c:when>
											<c:otherwise><input type="radio" name="sex" value="false" checked="true">男 <input
											type="radio" name="sex" value="true" >女</c:otherwise>
										</c:choose>
										
									</div>
									<div class="form-group">
										<label>描述</label> <span class="text-light-blue">写一段自我介绍吧，一个好的介绍可以直接打动别人。</span>
										<textarea name="description" class="form-control" rows="3"
											placeholder="自我介绍">${teacherAccount.info.description}</textarea>
									</div>
									<div class="form-group">
										<label>您是一名：</label> <br> <input type="radio"
									...
									<div class="form-group">
										<label>教育信息</label> <span class="text-light-blue">如果是在校大学生请写所上的学校，如果是老师请写任教学校。</span>
										<input type="text" name="school" class="form-control"
											placeholder="请输入教育信息" value="${teacherAccount.info.school}" />
									</div>
									<div class="form-group">
										<label>授课时间</label> <span class="text-light-blue">什么时间方便授课（例如：周六周日全天等）。</span>
										<textarea name="freeTime" class="form-control" rows="3"
											placeholder="授课时间">${teacherAccount.info.freeTime}</textarea>
									</div>
									<div class="form-group">
										<label>身份认证信息</label> <input type="file" name="identityFile"
											class="btn">
									...
									<div class="form-group">
										<label>学历认证信息</label> <input type="file" name="educationFile"
											class="btn">
