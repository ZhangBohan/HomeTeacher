...
<body class="skin-blue">
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		<jsp:include page="../../common/sidebar_admin.jsp" flush="true">
			<jsp:param name="activeMenu" value="teacher_verify" />
		</jsp:include>
			...
			<section class="content">
				...
				<div class="row">
					...
					<div>
						...
						<form id="main-form" action="/admin/teacher/verify" method="get">
							...
							<div class="box">
								<table class="table table-bordered">
									<tbody>
										...
										<c:forEach var="teacherAccount" items="${teacherAccountList}">
											<tr>
												<td><a
													href="/admin/teacher/edit?username=${teacherAccount.username}">${teacherAccount.username}</a></td>
												...
												<td><a
													href="/admin/teacher/verify?username=${teacherAccount.username}&audited=true">通过</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
