...
<div class="form-box" id="login-box">
    <div class="header">管理员注册 | <a class="header-link" href="#">用户点我注册</a></div>
    <form action="" method="post">
        <div class="body bg-gray">
            <div class="form-group">
                <input type="text" name="phone" id="username" class="form-control" placeholder="手机号" value="18610733695" />
            </div>
            <div class="form-group">
        ...
        <div class="footer">
            ...
            <p>
                已有账号？<a href="/auth/login/admin" class="text-center">登录</a>
            </p>
        </div>
    </form>
</div>
